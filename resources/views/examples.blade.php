                        ...
                        <div class="p-6">
                            ...
                            <div class="ml-12">
                                <div class="mt-12 text-gray-600 dark:text-gray-400 text-sm">
                                  ...
                                  Images are links to API. Click on one to see it. <br />
                                  Add the following query parameters to url to generate a new image:
                                    <code>
                                        <p>
                                        crop-modifier in pixels:
                                            ?crop_height=x&crop_width=y
                                        resize-modifier in pixels:
                                            ?resize_height=x&resize_width=y
                                        </p>
                                    </code>
                                </div>
                            </div>
